...
<body>
 ...
 <div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 添加游戏 </strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="AddGame.action"  enctype="multipart/form-data" >
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="gamename" value="" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="gameurl" value="" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="gameintroduce"></textarea>
          <div class="tips"></div>
        </div>
      </div>
