...
<body>
  ...
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 帖子回复列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
...
PageClick = function(pageclickednumber) {
	window.location.href = "BBSReplyList.action?startPage=" + pageclickednumber;
