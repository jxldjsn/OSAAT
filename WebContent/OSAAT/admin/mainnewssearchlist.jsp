...
<!--<form method="post" action="" id="listform">-->
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 资讯搜索列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
...
PageClick = function(pageclickednumber) {
	window.location.href = "SearchNewsByKey.action?key=" + $("#key").val() + "&startPage=" + pageclickednumber;
