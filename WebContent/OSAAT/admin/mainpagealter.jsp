...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 修改主页信息</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="AlterIndexpage.action" enctype="multipart/form-data" >
      <input type="hidden" value="${indexpage.indexpageId}" name="indexpageId">
      <div class="form-group">
        <div class="label">
          <label>添加标题：</label>
        </div>
        <div class="field">
          <input type="text" class="input" name="title" value="${indexpage.title}" />
        </div>
      </div>
      <div class="form-group">
        <div class="label">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="sourceurl" style="height:80px" >${indexpage.sourceUrl}</textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea name="pageabstract" class="input" style="height:120px;">${indexpage.indexAbstract}</textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
...
window.onload=function(){ 
	...
	for(var i=0;i<obj.length;i++){  
	    if(obj[i].value=='${indexpage.sourceType}'){  
