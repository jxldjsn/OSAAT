...
<!-- Custom Theme files -->
<!-- navigation -->
<link href="../../media/css/selfinformation.css" rel="stylesheet" type="text/css"  />
				...
				<ul class="menu">
					...
					<li class="active"><a href="<%=basePath %>OSAAT/bbs/InvitationIndex.action?startPage=1">论坛</a>
						...
						<ul class="submenu">
							...
							<li><a href="<%=basePath %>OSAAT/bbs/MyInvitation.action">我的帖子</a></li>
	...
	<table width="100%">
    	<tr>
            ...
            <td width="72%" bgcolor="#28A7CD" class="lefttabletd">
            	<table width="100%">
                	<tr height="90px"><td width="20%" align="right"><p id="pagetitle">个人中心></p></td><td width="80%"><p id="pagetitle"><a href="selfInformation.jsp">我的资料</a></p></td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">用户名：</td><td width="80" class="contentcontent">${sessionScope.username}</td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">性&nbsp;&nbsp;别:</td><td width="80" class="contentcontent">${sessionScope.gender}</td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">年&nbsp;&nbsp;龄:</td><td width="80" class="contentcontent">${sessionScope.age}</td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">邮&nbsp;&nbsp;箱:</td><td width="80" class="contentcontent">${sessionScope.email}</td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">地&nbsp;&nbsp;址:</td><td width="80" class="contentcontent">${sessionScope.address}</td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">电&nbsp;&nbsp;话:</td><td width="80" class="contentcontent">${sessionScope.phone}</td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">Q Q 号码:</td><td width="80" class="contentcontent">${sessionScope.qq}</td></tr>
                    <tr height="300px"><td width="20%" align="right" class="contentelement">头&nbsp;&nbsp;像:</td><td width="80"><img src="<%=basePath %>${sessionScope.photo}" height="300" width="300"></td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">兴趣爱好:</td><td width="80" class="contentcontent">${sessionScope.hobbies}</td></tr>
                    <tr height="60px"><td width="20%" align="right" class="contentelement">自我介绍:</td><td width="80" class="contentcontent">${sessionScope.introduce}</td></tr>
                	<tr height="100px"><th></th></tr>
                </table>
            </td>
