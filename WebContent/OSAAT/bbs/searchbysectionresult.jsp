        ...
        <tbody>
	        ...
	        <c:forEach items="${InvitationList}" var="item" varStatus="status">
	          <tr>
	            ...
	            <td class="user-phone"><fmt:parseDate value="${item.invitationTime}" var="date" pattern="yyyy-MM-dd HH:mm:ss"/><fmt:formatDate value="${date}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
	          </tr>
	        </c:forEach>
          	<tr>
          	<th colspan="3">
          		<script>
					...
					PageClick = function(pageclickednumber) {
						...
						window.location.href = "SearchBySectionId.action?sectionId=" + $("#sectionId").val() + "&startPage=" + pageclickednumber;
					}
				  </script>
