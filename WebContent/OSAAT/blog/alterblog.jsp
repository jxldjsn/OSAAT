...
<script>
	...
	function setAbstract() {
		var newAbstract =  UE.getEditor('editor').getContentTxt().substring(0,80);
		document.getElementById('blogabstract').value = newAbstract;
	}
</script>
	...
	<table width="100%">
		<tr>
			...
			<td width="80%" bgcolor="#28A7CD">
				<form action="<%=basePath%>OSAAT/blog/MyBlogAlter.action" method="post" onsubmit="setAbstract()">
					<input type="hidden" name="blogId" value="${blog.blogId}">
					<input type="hidden" name="blogAuthorId"
						value="${blog.blogAuthorid}">
					...
					<table width="100%">
						...
						<tr>
							...
							<td width="90%"><input type="text" id="Blogtitle"
								name="blogTitle" value="${blog.blogTitle}"></td>
						</tr>
						<tr>
						</tr>
						<tr>
							...
							<td width="90%" height="700px"><textarea id="editor"
									name="bolgContent" style="width: 100%; height: 560px;">${blog.blogContent}
	                            </textarea> 
						...
						<tr>
							<th colspan="2" align="center">
								<input type="hidden" id="blogabstract" name="blogabstract" value="${blog.blogAbstract}">
								<input id="submit"
								class="button orange" type="submit" value="提交"><input
								class="button orange" id="reset" type="reset" value="重置">
							</th>
						</tr>
						<tr height="50px"></tr>
					</table>
