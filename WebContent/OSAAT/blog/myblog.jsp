	...
	<table width="100%">
		<tr>
			...
			<td width="70%" bgcolor="#FFFFFF">
				...
				<table width="100%">
					<tr>
						<th colspan="3"><p align="center" id="MyBlog">我的博客</p></th>
					</tr>
					<tr height="60px">
					...
					<tr>
						<th colspan="3">
							<table width="100%" border="1">
								<tr onMouseOver="this.style.background='blanchedalmond'"
									...
									<td width="60%" align="center" class="content-content"><a
										href="<%=basePath %>OSAAT/blog/BlogDetail.action?blogId=${item.blogId}" onMouseOver="this.style.color='#6B12D9'"
										onMouseOut="this.style.color=''">${item.blogTitle}</a></td>
									<td width="20%" align="center">
										<table width="100%">
											<tr>
												<form action="<%=basePath %>OSAAT/blog/MyBlogDelete.action" method="post">
					...
					<script>
						...
						PageClick = function(pageclickednumber) {
							window.location.href = "MyBlog.action?startPage=" + pageclickednumber;
						}
					</script>
					<tr height="100px">
						<th colspan="3">
