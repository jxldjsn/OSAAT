...
<link href="../../media/css/gameindex.css" rel="stylesheet" type="text/css"  />
...
<script>
	...
	PageClick = function(pageclickednumber) {
		window.location.href = "AllGames.action?startPage=" + pageclickednumber;
	}
</script>
...
<body>
		...
		<div class="slider">
			<div class="callbacks_container">
				<ul class="rslides" id="slider">
					<li><img src="image/wuzhiqi.png" alt="炫酷五子棋" />
						<div class="caption">
							<h2>炫酷五子棋</h2>
							<a class="more" href="minigames/xuankuwuziqi/index.html" target="_black">进入游戏</a>
						</div></li>
					<li><img src="image/menmensuizhei.png" alt="萌萌水贼" />
						<div class="caption">
							<h2>萌萌水贼</h2>
							<a class="more" href="minigames/mengmengshuizhei/index.html" target="_black">进入游戏</a>
						</div></li>
					<li><img src="image/yibiliancheng.png" alt="一笔连成" />
						<div class="caption">
							<h2>一笔连成</h2>
							<a class="more" href="minigames/yblc/index.html" target="_black">进入游戏</a>
						</div></li>
					<li><img src="image/buyudaren.png" alt="捕鱼达人" />
						<div class="caption">
							<h2>捕鱼达人</h2>
							<a class="more" href="minigames/buyudaren/index.html">进入游戏</a>
						</div></li>
					<li><img src="image/tuzikuaipao.png" alt="兔子快跑" />
						<div class="caption">
							<h2>兔子快跑</h2>
							<a class="more" href="minigames/tuzikuaipao/index.html" target="_black">进入游戏</a>
						</div></li>
				</ul>
			</div>
		</div>
    ...
    <div class="container">
    <h3 class="title title1">小游戏主页</h3>
    <div class="team-info">
	    <c:forEach items="${gamelist}" var="item" varStatus="status">
	    	<div class="col-md-3 team-grids wow bounceIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: bounceIn;">
	    	 	<a href="${item.gameUrl}" target="_black"> 
	    			 <img class="img-responsive" src="<%=basePath %>${item.gameCoverUrl}" alt="">
	          			<div class="captn">
	          				<h4>${item.gameName}</h4>
	          				<p>${item.gameIntroduce}</p>
	        			</div>
	          	</a> 
	          	<div style="margin: 10px auto 20px auto; vertical-align: middle;"><a href="<%=basePath %>OSAAT/games/AddToMyGames.action?gameId=${item.gameId}" class="hvr-round-corners button2">添加到我的游戏</a></div>
	          </div>
