...
<link href="../../media/css/indexstyle.css" rel="stylesheet" type="text/css"
	media="all" />
    
<link href="../../media/css/savegame.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<!--buildings-->
	<div id="maincontent">
    	<h1 align="center" style="color:#FFFFFF">添加小游戏</h1>
        <div id="content">
            <form method="post" action="AddGame.action">
                <div class="contentpackage">	    
                    <div class="contentname">游戏名称：</div><input type="search" name="gameName" placeholder="请输入游戏名称！">
                </div>
                <div class="contentpackage">
                    <div class="contentname">游戏路径：</div><input type="text" name="gameUrl" class="" placeholder="请输入游戏的路径！">
                </div>
                 <div class="contentpackage">
                    <div class="contentname">封面路径：</div><input type="text" name="gameCoverUrl" class="" placeholder="请输入游戏封面的路径！">
                </div>
                
                <div class="contentpackage"><input type="submit" value="提交"></div>
            </form>
        </div>
    </div>
	<!--buildings-->
