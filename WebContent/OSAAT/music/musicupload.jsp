...
<head>
    ...
    <script id="jquery" type="text/javascript" class="library" src="Js/jquery-2.1.1.min.js"></script>
    <script type="text/javascript" language="javascript" src="Js/addsong.js"></script>
    <script type="text/javascript" language="javascript" src="Js/xcConfirm.js"></script>
...
<body>
	<div id="WZYmusic">
        ...
        <p align="right" style="margin-top:-65px;">
        	<a href="AllMySong.action" class="btn twitter">
            ...
            <span>&nbsp;&nbsp;</span>
            <a href="MusicIndex.action" class="btn twitter">
            	<i class="icons fi-social-twitter"></i>
    			<span class="text">
            		音乐
                </span>
    ...
    <div id="addMySong">
    	...
    	<form method="post" action="AddMyMusic.action" enctype="multipart/form-data" onSubmit="return checkMusicInformation();" >
            <!-- <form action="UploadMusic.action" method="post" enctype="multipart/form-data"  onSubmit="return checkMusic();" > -->
                <div class="uploader white">
                	...
                	<!-- <input type="hidden" value="${songImageFileName}" name="songImageFileName" > 
                	
                	<input type="submit" class="btns" onmouseover="this.style.backgroundPosition='left -40px'" onmouseout="this.style.backgroundPosition='left top'" value="上传此歌曲" />-->
